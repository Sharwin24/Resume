...
\columnratio{0.68} % 0.65 - 0.75
    ...
    \begin{itemize}
        \item Reduced mobile robots' downtime with optimizations to the fleet's navigation behavior
        \item Optimized robot behavior when navigating to chargers, robot queues, and pick-up/drop-off points
    \end{itemize}
