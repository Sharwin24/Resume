...
\begin{paracol}{2}
    ...
    \begin{itemize}
        ...
        \item Collaborated with professor Rifat Sipahi (r.sipahi@northeastern.edu) to make the robot arm into a kit for the course ME3460: Robotic Dynamics and Control.
    \end{itemize}
