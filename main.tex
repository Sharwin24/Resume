...
\begin{document}
\name{Sharwin Patil}
% \tagline{Co--op/Internship Availability: June -- December 2023}
% \tagline{}
...
\begin{paracol}{2}
    ...
    \begin{itemize}
        ...
        \item Relevant Courses: Object-Oriented Design, Algorithms \& Data, Robotics Sensing \& Navigation, Robotic Science \& Systems, Computer Systems, Embedded Design: Enabling Robotics, Circuits \& Signals: Biomedical Applications, Robot Dynamics \& Control.
        ...
        \item Fundamental Courses: Software Engineering, Computer Science (\rom{2}), Electronics, Digital Design \& Computer Organization, Networks, Cornerstone of Engineering, Calculus (\rom{3}), Differential Equations \& Linear Algebra, Probability \& Statistics.
        \item Activities: \href{https://web.northeastern.edu/nurobotics/}{NURobotics Club} Project Lead and Lead Intro Course Instructor, Club Water Polo President, First-year Engineering Tutor.
    \end{itemize}
    ...
    \cvevent{\href{https://www.greensightag.com/}{GreenSight}}{| UAV Robotics Engineer Co--op}{06/2023 -- 12/2023}{Boston, MA}
    \begin{itemize}
        \item Developed RTOS firmware for communications between a swarm of nano-drones and GCS over LoRa.
        \item Programmed a micro-controller with firmware for current sensing and management of a docking station.
    \end{itemize}
    \cvevent{\href{https://www.fulfil.com/}{Fulfil Solutions Inc}}{| Robotics Software Controls Co--op}{07/2022 -- 12/2022}{Redwood City, CA}
    \begin{itemize}
    ...
    \end{itemize}
    \cvevent{Northeastern University}{| Robotic Arm Educational Kit Research}{05/2022 -- present}{Boston, MA}
    \begin{itemize}
    ...
    %     \item Member of the FYELIC Advisory team, which guides and aids prospective FYELIC tutors.
    % \end{itemize}
    ...
    \cvtag{PEAK Experience Summit Award 2023}
    % ----- AWARDS -----
    ...
    \vspace{-2em}
    \cvsection{Projects}
    % \cvevent{Robot Arm Educational Kit}{\cvrepo{| \faGithub}{https://github.com/Sharwin24/Robotic-Arm}}{05/2022 -- present}{}
    % \begin{itemize}
    ...
    %     \item Collaborated with professor Rifat Sipahi to make the robot arm into a kit for the course ME3460: Robotic Dynamics and Control.
    % \end{itemize}
    \cvevent{AGV Motion-Planning}{\cvrepo{| \faGithub}{https://github.com/Sharwin24/HSKY}}{09/2022 -- 12/2022}{}
    \begin{itemize}
    ...
    \end{itemize}
    \cvevent{Chess Robot}{\cvrepo{| \faGithub}{https://github.com/Connor205/Chess-Robot-NURobotics}}{03/2021 -- 05/2022}{}
    \begin{itemize}
    ...
    \end{itemize}
    \cvevent{Aquatic Swarm Robots}{\cvrepo{| \faGithub}{https://github.com/Sharwin24/RoboTech}}{04/2022}{Atlanta, GA}
    \begin{itemize}
    ...
    \end{itemize}
    \cvevent{Image Manipulator}{\cvrepo{| \faGithub}{https://github.com/Sharwin24/Image-Manipulation-and-Enhancement}}{06/2021}{}
    \begin{itemize}
