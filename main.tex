...
\begin{paracol}{2}
    ...
    % ----- EDUCATION -----
    \cvsection{Education}
    \cvevent{Northwestern University }{| Candidate for M.S. in Robotics}{Expected Graduation: 12/2025}{Chicago, IL}
    \begin{itemize}
        \item Relevant Courses: Embedded Systems in Robotics, Robotics Manipulation, Lagrangian Dynamics, Machine Learning
    \end{itemize}
    ...
    \begin{itemize}
        ...
        \item Activities: \href{https://web.northeastern.edu/nurobotics/}{NURobotics} Project Lead \& Lead Intro Course Instructor, Club Water Polo President, First-year Engineering Tutor, Teaching Assistant for Robot Dynamics \& Control.
    \end{itemize}
    ...
    % \end{itemize}
    % ----- EDUCATION -----
    \vspace{-2.8em} % Reduce space between Header and preceding text
    % ----- EXPERIENCE -----
    ...
    \begin{itemize}
        ...
        \item Implemented a Hardware-Abstraction-Layer (HAL) in C for the ESP32 platform to interface with a custom LoRa chipset.
              % \item Created a web-server in C for the ESP32 platform.
    \end{itemize}
    ...
    \end{itemize}
    \cvevent{Northeastern University}{| Robotic Arm Educational Kit Research}{05/2022 -- 05/2024}{Boston, MA}
    \begin{itemize}
    ...
    \end{itemize}
    % \cvevent{Suspension Robotics}{| Robotics Software Engineer}{01/2023 -- 05/2023}{Boston, MA}
    % \begin{itemize}
    %     \item Developed communications firmware for a 6-DOF cable driven parallel robot in C++ using I2C/SPI.
    %     \item Implemented cable-control algorithm for constant cable tension during robot motions.
    % \end{itemize}
    ...
    \cvtag{SOLIDWORKS Associate (CSWA)}
