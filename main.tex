...
\begin{paracol}{2}
    ...
    \begin{itemize}
        \item Relevant Courses: ROS, Robotics Manipulation, Dynamics, Machine Learning
    \end{itemize}
    ...
    \begin{itemize}
        ...
        \item Activities: \href{https://web.northeastern.edu/nurobotics/}{NURobotics} Project Lead \& Lead Intro Course Instructor, Club Water Polo President, First-year Engineering Tutor, TA for Robot Dynamics \& Control.
    \end{itemize}
    ...
    % \end{itemize}
    % ----- EDUCATION -----
    \vspace{-1.85em} % Reduce space between Header and preceding text
    % ----- EXPERIENCE -----
