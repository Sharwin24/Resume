...
\begin{paracol}{2}
    ...
    \begin{itemize}
        ...
        \item Relevant Courses: Object Oriented Design, Algorithms and Data, Computer Systems, Embedded Design: Enabling Robotics, Circuits and Signals: Biomedical Applications, Robot Dynamics and Control, Robotics.
    ...
    \cvevent{Fulfil Solutions Inc}{| Incoming Robotics Software Controls Co--op}{07/2022 -- 12/2022}{Redwood City, CA}
    % \begin{itemize}
    %     \item Note about working at Fulfil
    % \end{itemize}
    ...
    \vspace{-2em}
    \cvsection{Projects}
    \cvevent{Image Manipulator in Java}{\cvrepo{| \faGithub}{https://github.com/Sharwin24/Image-Manipulation-and-Enhancement}}{06/2021}{}
    \begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Implemented Arduino and Rasberry Pi components to read the board state using computer vision, control stepper motors, and display information to the user.
        \item Incorporate a Chess AI to play against a human player.
    \end{itemize}

    \cvevent{Autonomous Swarm Marine Robots}{\cvrepo{| \faGithub}{https://github.com/Sharwin24/RoboTech}}{04/2022}{Atlanta, GA}
    \begin{itemize}
