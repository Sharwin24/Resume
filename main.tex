...
\columnratio{0.68} % 0.65 - 0.75
    ...
    \begin{itemize}
        \item Writing C\# behavioral code for automated fulfilment systems focusing on grocery packing robots
    \end{itemize}
    ...
    \begin{itemize}
        ...
        \item Democratized access to navigation behaviors by integrating new features into the existing ROS-based architecture
    \end{itemize}
    ...
    % \end{itemize}
    \cvevent{\textbf{Extended Kalman Filter for 6-Wheel Mars Rover}}{}{\textit{07/2025 -- Present}}{}
    \begin{itemize}
        \item Derived and implemented an Extended Kalman filter in C++ for state estimation, fusing data from wheel encoders, an IMU, and a LiDaR
        \item Simulated the rover's kinematics in Python to tune process and measurement noise covariances and visualize planned trajectories
