...
\columnratio{0.68} % 0.65 - 0.75
    ...
    % ----- EDUCATION -----
    \cvsection{Education}
    \cvevent{\textbf{Northwestern University} }{| Master of Science in Robotics}{Expected Graduation: 12/2025}{Chicago, IL}
    % \begin{itemize}
    %     \item Relevant Courses: ROS, Robotic Manipulation, Mechatronics, Dynamics, Machine Learning, Deep Learning.
    % \end{itemize}
    \cvevent{\textbf{Northeastern University} }{| B.S. in Computer Engineering \& Computer Science, Minor in Robotics}{Graduated: 05/2024}{Boston, MA}
    % \begin{itemize}
    ...
    \cvsection{Skills}
    \begin{itemize}
        \item[] \textbf{Software:} C, C++, ROS/ROS2, Python, C\#, Java, MATLAB, Linux, Git, Unity
        \item[] \textbf{Hardware:} SolidWorks (CSWA), KiCad, Arduino
    \end{itemize}
    % \cvtag{Embedded C}
    % \cvtag{ROS/ROS2}
    % \cvtag{C++}
    ...
    \end{itemize}
    \cvevent{\textbf{Toasting Bread with Franka Robot Arm}}{}{11/2024 -- 12/2024}{}
    \begin{itemize}
