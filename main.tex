...
\begin{paracol}{2}
    ...
    \begin{itemize}
        ...
        \item Fundamental Courses: Computer Science (\rom{2}), Electronics, Digital Design and Computer Organization, Networks, Cornerstone of Engineering, Calculus (\rom{3}), Differential Equations \& Linear Algebra, Probability and Statistics.
    ...
    \begin{itemize}
        \item Developed automation software in C\# for various robotic systems.
        \item Brainstormed innovative solutions for optimizing factory operations.
    \end{itemize}
