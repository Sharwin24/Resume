...
\begin{document}
\name{Sharwin Patil}
\tagline{Co--op/Internship Availability: July -- December 2023}
% \tagline{}
...
\begin{paracol}{2}
    ...
    \cvevent{Fulfil Solutions Inc}{| Robotics Software Controls Co--op}{07/2022 -- 12/2022}{Redwood City, CA}
    \begin{itemize}
        \item Developed sequencing code in C\# for high-level control of various robotic systems.
        \item Task assignment for heterogeneous robotic agents.
        \item Optimized AGV planning and curated heuristics for improving factory performance.
        \item Enabled factory-wide alerts and notifications for operators to react with relevant safety measures.
    \end{itemize}
    ...
    \begin{itemize}
        ...
        \item Collaborated with professor Rifat Sipahi to introduce the kit to the course ME3460: Robotic Dynamics and Control.
    \end{itemize}
    \cvevent{Northeastern University}{| First-Year Engineering Tutor}{01/2021 -- 05/2022}{Boston, MA}
    \begin{itemize}
