...
\columnratio{0.68} % 0.65 - 0.75
    ...
    % ----- EDUCATION -----
    \cvsection{Education}
    \cvevent{Northwestern University }{| M.S. in Robotics}{Expected Graduation: 12/2025}{Chicago, IL}
    \begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Relevant Courses: Robot Sensing \& Navigation, Robot Dynamics \& Control, Robotics science and 
    \end{itemize}
    % ----- EDUCATION -----
    \vspace{-1.4em}
    % ----- EXPERIENCE -----
    \cvsection{Experience}
    \cvevent{GreenSight}{| UAV Robotics Engineer Co--op}{06/2023 -- 12/2023}{Boston, MA}
    \begin{itemize}
    ...
    % ----- PROJECTS -----
    \cvsection{Projects}
    \cvevent{Automated Poker Table}{\cvrepo{| \faGithub}{https://github.com/Connor205/B-I-K-E}}{01/2023 -- 04/2023}{}
    \begin{itemize}
    ...
    \end{itemize}
    \cvevent{Robot Arm Educational Kit}{\cvrepo{| \faGithub}{https://github.com/Sharwin24/Robotic-Arm}}{05/2022 -- 05/2024}{}
    \begin{itemize}
    ...
    \end{itemize}
    \cvevent{Robot Pen Thief}{\cvrepo{| \faGithub}{https://github.com/Sharwin24/Pen-Challenge}}{09/2024 -- 10/2024}{}
    \begin{itemize}
        \item Implemented an image pipeline with OpenCV to tune computer vision using the Intel Realsense camera for object centroid identification.
        \item Sequenced the image pipeline with a controller for a robot arm to perform a grasping task with the end-effector.
    \end{itemize}
