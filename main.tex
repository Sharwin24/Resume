...
\begin{paracol}{2}
    ...
    %%% Some C/C++ Project from Systems or Robotics, etc.
    % \cvevent{Custom mini-shell in C}{\cvrepo{| \faGithub}{https://github.com/Sharwin24/CS3650}}{02/2022}{}
    % \begin{itemize}
    %     \item[] \textbf{CS3650: Computer Systems}
    %     \item Created a custom shell aimed to mimic a Linux terminal in C.
    %     \item 
    % \end{itemize}
