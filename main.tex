...
\begin{paracol}{2}
    ...
    \begin{itemize}
        ...
        \item Activities: \href{https://web.northeastern.edu/nurobotics/}{NURobotics Club} Project Lead and former Lead Intro Course Instructor, Club Water Polo President, First-year Engineering Tutor.
    \end{itemize}
    ...
    \begin{itemize}
        \item Developed RTOS firmware for communications between a swarm of nano-drones and GCS.
    \end{itemize}
