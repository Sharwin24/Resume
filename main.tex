...
\columnratio{0.68} % 0.65 - 0.75
    ...
    % ----- EDUCATION -----
    \cvsection{Education}
    \cvevent{\textbf{Northwestern University}}{| \textbf{Master of Science in Robotics}}{\textit{Graduation: 12/2025}}{\textit{Chicago, IL}}
    ...
    \cvevent{\textbf{Fulfil Solutions}}{| \textbf{Robotics Software Engineer}}{\textit{10/2025 -- Present}}{\textit{Mountain View, CA}}
    \begin{itemize}
        \item Developed C\# behavior orchestration code for automated fulfillment systems optimizing multi-robot coordination
        \item Optimized multi-agent task scheduling algorithms, increasing system throughput by 10--15\%
    \end{itemize}
    \cvevent{\textbf{Locus Robotics}}{| \textbf{Planning \& Controls Intern}}{\textit{06/2025 -- 09/2025}}{\textit{Remote}}
    \begin{itemize}
        \item Developed ROS services bridging C++ navigation stack and Python behavior layer to optimize fleet-level coordination
        \item Performance-tested ROS services on large-scale maps to validate scalability for fleets of hundreds of robots
        \item Integrated reusable navigation features into existing ROS architecture to expand access to fleet behaviors
    \end{itemize}
    ...
    \begin{itemize}
        ...
        \item Implemented a Hardware-Abstraction-Layer (HAL) in C for the ESP32 platform to interface with a custom LoRa chipset using SPI
    ...
    % ----- PROJECTS -----
    \cvsection{Projects}
    \cvevent{\textbf{Open Source Potential Field Motion Planner}}{}{\textit{04/2025 -- 12/2025}}{}
    \begin{itemize}
        \item Developed a real-time C++ motion planning library using potential fields for whole-body collision avoidance
        \item Authored a modular C++ framework and ROS2 package enabling rapid integration across diverse robot platforms
        \item Engineered trajectory generation with RK4 integration, soft saturation, and rate limiting for smooth motion
    \end{itemize}
    % \cvevent{\textbf{ROS2 Delta Robot}}{}{\textit{01/2025 -- 03/2025}}{}
    % \begin{itemize}
    ...
    % \end{itemize}
    \cvevent{\textbf{Extended Kalman Filter for 6-Wheel Mars Rover}}{}{\textit{07/2025 -- 09/2025}}{}
    \begin{itemize}
        \item Derived and implemented an Extended Kalman Filter in C++ fusing IMU, wheel encoder, and LiDAR measurements
        \item Simulated rover kinematics in Python to tune process and measurement noise covariances
        \item Architected a ROS2 package for real-time sensor interfacing and state estimation pipelines
    \end{itemize}
    ...
    \begin{itemize}
        ...
        \item Derived combined Jacobians for omni-directional base and arm to generate coordinated velocity trajectories
    \end{itemize}
