...
\columnratio{0.68} % 0.65 - 0.75
    ...
    \cvsection{Skills}
    \begin{itemize}
        \item[] \textbf{Robotics:} ROS/ROS2, Nav2, MoveIt, RViz2, Gazebo, OpenCV, PID Control, Robot Kinematics \& Dynamics
    ...
    \begin{itemize}
        \item Designed and fabricated a 3-DOF delta robot using 3D printed parts
        \item Created open-source ROS2 packages to interface with the robot
    \end{itemize}
    ...
    \end{itemize}
    \cvevent{\textbf{Mobile Manipulator Simulation}}{}{\textit{11/2024 -- 12/2024}}{}
    \begin{itemize}
        \item Implemented a task-space feed-forward controller for the KUKA YouBot in Python for pick and place tasks
        \item Derived Jacobian for omni-directional mobile base and robotic arm to generate velocity trajectories
    \end{itemize}
